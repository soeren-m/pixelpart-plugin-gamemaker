...
public class MainActivity {
	...
	// Effect runtime
	public static native String JNIpixelpartloadeffectresource(String data, double size);
	public static native double JNIpixelpartdeleteeffectresource(String resourcePtr);
