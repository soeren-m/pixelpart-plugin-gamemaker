/// @desc Float3 property animated with keyframes and affected by effect inputs.
...
function PixelpartAnimatedPropertyFloat3(_property_ptr) constructor
{
	...
	/// @returns {array} Value (x, y, z) of the property
	...
	/// @param {real} _index Keyframe index
	/// @returns {array} Keyframe value (x, y, z)
	...
	{
		return pixelpart_animated_property_float3_keyframe_index(property_ptr, _position, _epsilon);
	}
