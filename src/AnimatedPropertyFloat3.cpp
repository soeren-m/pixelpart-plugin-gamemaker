...
GM_EXPORT pixelpart_gm::real GM_API pixelpart_animated_property_float3_enable_adaptive_cache(pixelpart_gm::string propertyPtr) {
	pixelpart::AnimatedProperty<pixelpart::float3_t>* property = pixelpart_gm::parsePtr<pixelpart::AnimatedProperty<pixelpart::float3_t>>(propertyPtr);
	if(!property) {
		pixelpart_gm::lastError = pixelpart_gm::invalidPropertyError;
		return -1;
...
GM_EXPORT pixelpart_gm::real GM_API pixelpart_animated_property_float3_enable_fixed_cache(pixelpart_gm::string propertyPtr, pixelpart_gm::real size) {
	pixelpart::AnimatedProperty<pixelpart::float3_t>* property = pixelpart_gm::parsePtr<pixelpart::AnimatedProperty<pixelpart::float3_t>>(propertyPtr);
	if(!property) {
		pixelpart_gm::lastError = pixelpart_gm::invalidPropertyError;
		return -1;
