function PixelpartAnimatedPropertyFloat2(_property_ptr) constructor
{
	...
	{
		pixelpart_animated_property_float2_keyframe_index(property_ptr, _position, epsilon);
	}
	...
	{
		pixelpart_animated_property_float2_enable_adaptive_cache(property_ptr);
	}
	static enable_fixed_cache = function(size)
	{
		pixelpart_animated_property_float2_enable_fixed_cache(property_ptr, size);
	}
}
